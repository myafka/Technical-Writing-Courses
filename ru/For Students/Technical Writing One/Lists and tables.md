...
- Если вы переставите элементы в *нумерованном* списке, смысл списка изменится. Например, мы ниже мы используем маркированный список, потому что перестановка его элементов не меняет смысла списка:
